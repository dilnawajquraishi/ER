...
const Createaddbuyer = () => {
    return (
        <div className='w-75  ms-5 ' style={{ height: "40rem" }}>
            <div className='w-auto mt-3  h-10 flex flex-row justify-between '>
                ...
                <div className='sub-div w-auto h-10 mb-4 ' style={{ borderLeft: "none", borderRight: "none", borderTop: "none" }}>
                    <button className='head-button w-28  text-white ms-3 h-10 ' style={{ border: "1px solid purple", borderTop: "none", borderRight: "none", borderLeft: "none" }}><FaBars /> Add Buyer</button>
            ...
            <div className='w-auto h-16 flex flex-row  gap-10 ms-2' style={{ height: "70vh" }}>
                ...
                <div className='w-auto h-15  bg-white   flex flex-row ' >
                    ...
                    <div className='w-auto h-15  bg-white   flex flex-row ' >
                        <input type='password' placeholder='Enter Phone Number' className='w-80 h-10' style={{ outline: "none" }} />
                    </div>
                    <div className='w-auto h-15  bg-white   flex flex-row ' >
                        <input type='  password' placeholder=' Enter Password' className='w-80 h-10' style={{ outline: "none" }} />
                    </div>
                    <div className='w-auto  bg-red-400  flex flex-row'>
